        ...
        >
          <div className="max-w-[1400px] mx-auto px-6 lg:px-12 h-[64px] flex items-center justify-between gap-4">
            <div className="flex flex-col gap-0.5">
              <p className="font-serif text-[#0B2545] font-semibold" style={{ fontFamily: "var(--font-serif)", fontSize: "1.05rem" }}>
            ...
            <div className="flex items-center gap-4 flex-shrink-0">
              ...
              >
                <svg viewBox="0 0 16 16" fill="none" stroke="#C6A77D" strokeWidth="1.3" className="w-3.5 h-3.5">
              ...
              <a
                href="#contact"
                className="px-6 py-2.5 bg-[#C6A77D] text-[#1A1A1A] label-small font-semibold tracking-[0.1em] rounded-sm hover:bg-[#0B2545] hover:text-white transition-all duration-300 shadow-sm"
              >
                Đăng Ký Tư Vấn Ngay
              </a>
            </div>
