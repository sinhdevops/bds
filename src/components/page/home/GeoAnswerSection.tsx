const GEO_ANSWERS = [
  ...
  },
  {
    ...
    answer:
      "Bảng giá căn hộ thay đổi theo mã căn, tầng, hướng view, chính sách bán hàng và tình trạng giỏ hàng. Cách chính xác nhất là gửi nhu cầu hoặc gọi hotline 0325 610016 để được cập nhật giỏ hàng hiện tại.",
  },
  {
