  ...
  return (
    ...
    >
      ...
      <div className="relative aspect-[4/3] overflow-hidden">
        ...
        {badge && (
          <div className="absolute top-4 left-4">
            <span
              className="px-3 py-1.5 bg-[#111111]/70 backdrop-blur-sm label-small text-gold"
      ...
      <div className="p-6 flex-1 flex flex-col">
        ...
        <p className="text-[#5F5F5F] text-xs font-light mb-5 leading-snug">
          {view}
        </p>
        ...
        <div className="flex items-end justify-between">
          <div>
            <span
              className="label-small text-[#5F5F5F] block mb-0.5"
              style={{ fontSize: "0.6rem" }}
            >
              Giá từ
            </span>
          ...
          <motion.a
            href="#contact"
            className="flex items-center gap-2 px-4 py-2 border border-[rgba(0,0,0,0.1)] text-[#111111] label-small hover:border-[#B89B72] hover:text-gold transition-colors duration-300 group"
            whileHover={{ x: 2 }}
          ...
          >
            ...
            <svg
              ...
              stroke="currentColor"
              strokeWidth="1.2"
              className="w-4 h-2.5 group-hover:translate-x-0.5 transition-transform duration-200"
            >
