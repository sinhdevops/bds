...
const ContactHero = () => {
  return (
    <section className="relative w-full h-[45vh] min-h-[340px] overflow-hidden flex items-center justify-center bg-[#0B2545]">
      {/* Background Image */}
      <Image
        src="https://images.unsplash.com/photo-1451187580459-43490279c0fa?w=1800&q=80&fit=crop"
        alt="SRT Miền Trung customer desk"
        fill
      ...
      <div className="relative max-w-[1400px] mx-auto px-6 lg:px-12 text-center z-10 pt-20">
        ...
        >
          Chúng tôi luôn sẵn lòng lắng nghe, hỗ trợ tư vấn và cung cấp những giải pháp bất động sản đắc địa nhất cho quý khách.
        </motion.p>
      </div>
    </section>
  );
