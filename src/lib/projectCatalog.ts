...
export const PROJECT_CATALOG: ProjectCatalogItem[] = [
  {
    ...
    idealFor: "Khách cần căn hộ sở hữu lâu dài, chính sách dòng tiền tốt và giỏ hàng đẹp tại khu vực Nam Đà Nẵng.",
    ...
    segment: "urban",
    summary:
      "FourS Tower Đà Nẵng được định vị như giỏ hàng căn hộ sở hữu lâu dài khan hiếm, tập trung vào vị trí Nam Đà Nẵng, view sông - công viên và chính sách thanh toán hỗ trợ dòng tiền.",
